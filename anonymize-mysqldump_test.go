...
var (
	...
	usersQueryWithNullValues           = "INSERT INTO `wp_users` VALUES (3,'username','user_pass','username',NULL,'','2019-06-12 00:59:19','',0,'username');\n"
	usersQueryWithNullValuesRecompiled = "insert into wp_users values (3, 'mandy_hintz', 'ceMD3bN8gsQ', 'tobin', null, '', '2019-06-12 00:59:19', '', 0, 'Sasha Auer PhD');\n"
...
func TestSetupAndProcessInput(t *testing.T) {
	...
	var tests = []struct {
		...
		{
			testName: "users query with null values",
			query:    usersQueryWithNullValues,
			wants:    usersQueryWithNullValuesRecompiled,
		},
	}
